...
//        submitButton.isHidden = true
    ...
    func submitQuiz() -> Int{
        ...
        if answeredQuestions.contains(false) {
            let alert = UIAlertController(title: "Error", message: "Kindly complete all questions before submitting.", preferredStyle: .alert)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
           if segue.identifier == "showScore" {
               if let destinationVC = segue.destination as? FinalResultViewController {
